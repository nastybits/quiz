...
export const dumbQuestions = [
  {
    id: 1,
    title: "Вопрос 1",
    text: "Грациозную и опасную Марле́н Ди́трих влюблённый Э́рих Мари́я Рема́рк называл ЕЮ — но, конечно, не ТАКОЙ ЕЮ.",
    question: "В какой стране происходит бо́льшая часть недавнего фильма «ТАКАЯ ОНА»?",
    answer: "Ваканда.",
    comment: "Ремарк называл Марлен Дитрих пантерой, но вряд ли имел в виду чёрную пантеру, так как Марлен была блондинкой. Фильм 2018 года «Чёрная пантера» рассказывает о супергерое из вымышленной африканской страны Ваканды.",
    img: "marlen.png",
    music: "music1.mp3"
  },
  {
